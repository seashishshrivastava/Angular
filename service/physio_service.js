angular.module('App').factory('physioService', function ($q, $http, appInfo) {
    var apiUrl = appInfo.apiUrl;
    return {
        AddPhysio: function (reqData) {
        ...
        getPhysioList: function (reqData) {
            var deferred = $q.defer();
            $http.post(SITE_URL + "api/physio/getPhysioList", reqData).success(function (data) {
                deferred.resolve(data);
                //alert("success" + data)
            }).error(function (data) {
                deferred.reject(data);
        ...
        deletePhysio: function (reqData) {
            var deferred = $q.defer();
            $http.post(SITE_URL + "api/physio/deletePhysio", reqData).success(function (data) {
                deferred.resolve(data);
                //alert("success" + data)
            }).error(function (data) {
                deferred.reject(data);
